...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { account_client_id: @reminder.account_client_id, message: @reminder.message } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { account_client_id: @reminder.account_client_id, message: @reminder.message } }
