...
ActiveRecord::Schema.define(version: 2021_08_03_031554) do
  ...
  create_table "provided_services", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_provided_services_on_account_id"
    t.index ["client_profile_id"], name: "index_provided_services_on_client_profile_id"
  end

  create_table "receive_payment_links", force: :cascade do |t|
    t.bigint "name"
    t.string "link"
    t.bigint "account_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "index_receive_payment_links_on_account_id"
  end
  ...
  create_table "test_email_reminders", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "account_id", null: false
    t.index ["account_id"], name: "index_test_email_reminders_on_account_id"
  ...
  create_table "text_messages", force: :cascade do |t|
    ...
    t.index ["reminder_id"], name: "index_text_messages_on_reminder_id"
  end
